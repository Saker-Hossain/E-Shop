        ...
        if (fname_error != '' || lname_error != '' || email_error != '' || phone_error != '' || address1_error != '' || address2_error != '' || city_error != '' || state_error != '' || country_error != '' || pincode_error != '') {
            ...
            $.ajax({
                ...
                success: function(response) {
                    var options = {
                        "key": "rzp_test_MSTOhsxbsOejO2", // Enter the Key ID generated from the Dashboard
                        "amount": 1 * 168, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
                        "currency": "BDT",
